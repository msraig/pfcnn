...
#define taucs_gemm  SGEMM
#define taucs_potrf SPOTRF
#define taucs_herk  SSYRK
#define taucs_trsm  STRSM
#endif
...
#define taucs_gemm  DGEMM
#define taucs_potrf DPOTRF
#define taucs_herk  DSYRK
#define taucs_trsm  DTRSM
#endif
...
#define taucs_gemm  CGEMM
#define taucs_potrf CPOTRF
#define taucs_herk  CHERK
#define taucs_trsm  CTRSM
#endif
...
#define taucs_gemm  ZGEMM
#define taucs_potrf ZPOTRF
#define taucs_herk  ZHERK
#define taucs_trsm  ZTRSM
#endif
...
//taucs_double DNRM2(int*, taucs_double*, int*);
//taucs_single SNRM2(int*, taucs_single*, int*);
//taucs_double DZNRM2(int*, taucs_dcomplex*, int*);
//taucs_single SCNRM2(int*, taucs_scomplex*, int*);
