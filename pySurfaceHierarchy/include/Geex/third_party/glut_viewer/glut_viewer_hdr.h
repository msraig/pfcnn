...
extern "C" {
    ...
    void GLUT_VIEWER_API glut_viewer_hdr_set_exposure(float x) ;
    ...
    void GLUT_VIEWER_API glut_viewer_set_blur_amount(float x) ;
    void GLUT_VIEWER_API glut_viewer_set_blur_width(float x) ;   
    void GLUT_VIEWER_API glut_viewer_set_vignette(int do_vignette) ;
